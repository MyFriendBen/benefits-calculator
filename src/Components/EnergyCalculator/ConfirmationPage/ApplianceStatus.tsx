...
import { ReactComponent as AcUnit } from '../../EnergyCalculator/Icons/AcUnit.svg';
...
const ApplianceStatus = () => {
  ...
  return (
    <ConfirmationBlock
      icon={<AcUnit className="option-card-lucide-icon" title={formatMessage(applianceStatusIconAlt)} />}
      title={
        <FormattedMessage
