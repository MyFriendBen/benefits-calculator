              ...
              render={({ field }) => (
                <>
                  ...
                  {errors.agreeToTermsOfService && (
                    <ErrorMessageWrapper fontSize=".75rem">{errors.agreeToTermsOfService.message}</ErrorMessageWrapper>
                  )}
                </>
              )}
            />
            <Controller
              ...
              render={({ field }) => (
                <>
                  ...
                  />
                  {errors.is13OrOlder && (
                    <ErrorMessageWrapper fontSize=".75rem">{errors.is13OrOlder.message}</ErrorMessageWrapper>
                  )}
                </>
              )}
            />
