...
const NEEDS_MAPPING: Record<string, Topics> = {
  ...
  childDevelopment: {
    ...
    subtopic:
      'Educational%20Institutions%2FSchools%2CEducational%20Programs%2CEducational%20Support%20Services%2CIndividual%20and%20Family%20Support%20Services%2CSocial%20Development%20and%20Enrichment',
...
const buildQueryURL = (value: Topics, zipcode: string) => {
...
export default function NcLink211Message() {
  return (
    <Link211Message
      ...
      intro={<FormattedMessage id="link211nc.resources" defaultMessage="More local resources from NC211: " />}
      fallback={
        <div>
          <p>
