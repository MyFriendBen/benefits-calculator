  ...
  return (response: ScreenApiResponse) => {
    const updatedFormData: FormData = {
      ...
      benefits: {
        ...
        wa_eitc: response.has_eitc ?? false,
        ...
        nc_leap: response.has_leap ?? false,
        cesn_leap: response.has_leap ?? false,
        ...
        wa_nslp: response.has_nslp ?? false,
        oap: response.has_oap ?? false,
        cesn_oap: response.has_oap ?? false,
        pell: response.has_pell_grant ?? false,
        rtdlive: response.has_rtdlive ?? false,
        cesn_rtdlive: response.has_rtdlive ?? false,
        snap: response.has_snap ?? false,
        co_snap: response.has_snap ?? false,
        il_snap: response.has_snap ?? false,
        ma_snap: response.has_snap ?? false,
        nc_snap: response.has_snap ?? false,
        tx_snap: response.has_snap ?? false,
        cesn_snap: response.has_snap ?? false,
        wa_snap: response.has_snap ?? false,
        sunbucks: response.has_sunbucks ?? false,
        ssdi: response.has_ssdi ?? false,
        tx_ssdi: response.has_ssdi ?? false,
        cesn_ssdi: response.has_ssdi ?? false,
        wa_ssdi: response.has_ssdi ?? false,
        ssi: response.has_ssi ?? false,
        tx_ssi: response.has_ssi ?? false,
        cesn_ssi: response.has_ssi ?? false,
        wa_ssi: response.has_ssi ?? false,
        tanf: response.has_tanf ?? false,
        co_tanf: response.has_tanf ?? false,
        il_tanf: response.has_tanf ?? false,
        nc_tanf: response.has_tanf ?? false,
        tx_tanf: response.has_tanf ?? false,
        cesn_tanf: response.has_tanf ?? false,
        wa_tanf: response.has_tanf ?? false,
        wic: response.has_wic ?? false,
        co_wic: response.has_wic ?? false,
        il_wic: response.has_wic ?? false,
        ma_wic: response.has_wic ?? false,
        nc_wic: response.has_wic ?? false,
        tx_wic: response.has_wic ?? false,
        cesn_wic: response.has_wic ?? false,
        wa_wic: response.has_wic ?? false,
        ...
        co_section_8: response.has_section_8 ?? false,
        ma_section_8: response.has_section_8 ?? false,
        cesn_section_8: response.has_section_8 ?? false,
