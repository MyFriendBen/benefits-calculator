...
const getScreensBody = (formData: FormData, languageCode: Language, whiteLabel: string) => {
  ...
  const screenBody: ApiFormData = {
    ...
    has_ccap: formData.benefits.ccap ?? formData.benefits.il_ccap ?? formData.benefits.nc_cccap ?? null,
    has_erc: null,
    has_lifeline: formData.benefits.lifeline ?? null,
    has_leap: formData.benefits.leap ?? formData.benefits.nc_leap ?? null,
    ...
    has_oap: formData.benefits.oap ?? formData.benefits.cesn_oap ?? null,
    ...
    has_snap: formData.benefits.snap ?? formData.benefits.co_snap ?? formData.benefits.il_snap ?? formData.benefits.ma_snap ?? formData.benefits.nc_snap ?? formData.benefits.tx_snap ?? formData.benefits.cesn_snap ?? null,
    has_sunbucks: formData.benefits.sunbucks ?? null,
    has_ssdi: formData.benefits.ssdi ?? formData.benefits.tx_ssdi ?? formData.benefits.cesn_ssdi ?? null,
    has_ssi: formData.benefits.ssi ?? formData.benefits.tx_ssi ?? formData.benefits.cesn_ssi ?? null,
    has_cowap: formData.benefits.cowap ?? formData.benefits.cesn_cowap ?? null,
    has_ubp: formData.benefits.ubp ?? null,
    has_tanf: formData.benefits.tanf ?? formData.benefits.co_tanf ?? formData.benefits.il_tanf ?? formData.benefits.nc_tanf ?? formData.benefits.tx_tanf ?? formData.benefits.cesn_tanf ?? null,
    has_wic: formData.benefits.wic ?? formData.benefits.co_wic ?? formData.benefits.il_wic ?? formData.benefits.ma_wic ?? formData.benefits.nc_wic ?? formData.benefits.tx_wic ?? formData.benefits.cesn_wic ?? null,
    has_upk: formData.benefits.upk ?? null,
    has_coctc: formData.benefits.coctc ?? null,
    has_fatc: formData.benefits.fatc ?? null,
    has_section_8: formData.benefits.section_8 ?? formData.benefits.co_section_8 ?? formData.benefits.ma_section_8 ?? formData.benefits.cesn_section_8 ?? null,
    ...
    has_ma_heap: formData.benefits.ma_heap ?? null,
    ...
    has_co_andso: formData.benefits.co_andso ?? formData.benefits.cesn_andso ?? null,
    has_co_care: formData.benefits.co_care ?? formData.benefits.cesn_care ?? null,
