...
const getScreensBody = (formData: FormData, languageCode: Language, whiteLabel: string) => {
  ...
  const screenBody: ApiFormData = {
    ...
    has_snap: formData.benefits.snap ?? formData.benefits.cesn_snap ?? null,
    has_sunbucks: formData.benefits.sunbucks ?? null,
    has_ssdi: formData.benefits.ssdi ?? formData.benefits.cesn_ssdi ?? null,
    has_ssi: formData.benefits.ssi ?? formData.benefits.cesn_ssi ?? null,
    has_cowap: formData.benefits.cowap ?? formData.benefits.cesn_cowap ?? null,
    has_ubp: formData.benefits.ubp ?? null,
    has_tanf: formData.benefits.tanf ?? formData.benefits.cesn_tanf ?? null,
    has_wic: formData.benefits.wic ?? formData.benefits.cesn_wic ?? null,
