...
const getScreensBody = (formData: FormData, languageCode: Language, whiteLabel: string) => {
  ...
  const screenBody: ApiFormData = {
    ...
    has_eitc: formData.benefits.eitc || formData.benefits.wa_eitc || null,
    ...
    has_nslp: formData.benefits.nslp || formData.benefits.wa_nslp || null,
    ...
    has_head_start: formData.benefits.head_start || formData.benefits.wa_head_start || null,
