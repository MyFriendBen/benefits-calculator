...
const getHouseholdMemberBody = (householdMemberData: HouseholdData): ApiHouseholdMember => {
  ...
  return {
    ...
    has_work_study: householdMemberData.studentEligibility?.hasWorkStudy ?? null,
    works_at_least_20_hours: householdMemberData.studentEligibility?.worksAtLeast20Hours ?? null,
