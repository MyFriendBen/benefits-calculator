...
export const BREAKPOINTS = {
  /** Mobile/Desktop threshold - 774px and below is mobile, 775px+ is desktop */
  desktop: 775,
} as const;
 ...
 * @returns true if width is less than desktop breakpoint (0-774px)
 */
 ...
 * @param width - Current window width in pixels
 * @returns true if width is greater than or equal to desktop breakpoint (775px+)
 */
